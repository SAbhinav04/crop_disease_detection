...
def main() -> None:
    ...
    class_counts, class_weights = edp.get_class_distribution(paths["curated_cleaned"])
    split_counts = edp.strict_split(paths["curated_ready"], paths["train_dir"], paths["test_dir"])
